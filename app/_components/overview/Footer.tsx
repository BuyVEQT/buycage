    ...
    <footer className="mt-24 pt-2 text-[12px] text-[var(--fg-tertiary)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 pt-6 pb-16 border-t border-[var(--border)]">
        <p className="max-w-[680px] leading-relaxed">
          ...
          All-Equity Asset Allocation ETF ($CAGE). Market data is sourced from
          Yahoo Finance where available and may be delayed, cached, incomplete,
          or unavailable. Nothing here is investment advice, a recommendation,
          or an offer to buy or sell any security. Consult a registered advisor
          before investing. Past performance does not predict future results.
        </p>
